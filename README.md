...
<thead>
<tr>
<td style="text-align: left; vertical-align:top;"> <p> The power of this codebase is not for individual  <br />calculations.  Often those are easy enough to set up <br /> and manage by hand.  Rather, it's power is in the <br />ability to script together complex workflows, passing the Mol Object form one calculator to the <br />next, automating many calculations. </p> By building out functionality from the central Mol Object, everything will connect nicely together and allow much more flexibility when designing automated pipelines compared to stringing together sbatch scripts and hoping for the best. </td>
